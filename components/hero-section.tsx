...
export function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 mb-10 mt-20 md:mb-0 md:mt-0"
    >
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            through our comprehensive IT bootcamp programs. From networking to
            cybersecurity, we provide the skills you need to succeed.
          </motion.p>
