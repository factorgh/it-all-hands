    ...
    <footer className="bg-muted/30 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Transforming careers through comprehensive IT education and professional training programs.
            </p>
          ...
          {/* Courses */}
          <div className="space-y-4">
            <h4 className="font-semibold text-foreground">Our Programs</h4>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">© 2024 IT ALL HANDS. All rights reserved.</p>
